...
const MobileNav = ({ toggleSidebar }: MobileNavProps) => {
  return (
    <nav className="w-full  fixed top-0 flex flex-row justify-between items-center px-[40px] h-[80px] bg-[#1C1C1E] z-[99999] lg:hidden">
      ...
      <div>
        <button
          className="fill-[#6f7380] stroke-[#6f7380] hover:fill-customOrange hover:stroke-customOrange hover:bg-[#6f7380] transition-all duration-300 ease-in-out rounded-[12px]"
